...
'''
usage: $0 input_path*csv,xls,xlsx,xlsm,bmf,00t,isis,dm,dxf,tif,tiff,jsdb,shp,obj,msh expressions#code#name:input_path output_path*csv,xlsx,00t,tif,tiff,jsdb,shp,obj,msh fill_null_values@
'''
